//#region node_modules/.nitro/vite/services/ssr/assets/db-hhyiVbEC.js
...
var _0002_app_default = "-- Per-user app blobs (clientes, escenarios, cartera, informe).\n-- JSON payloads keep the existing client shapes; every row is scoped by user_id.\ncreate table if not exists user_store (\n  user_id    text not null,\n  kind       text not null,\n  payload    jsonb not null,\n  updated_at timestamptz not null default now(),\n  primary key (user_id, kind)\n);\ncreate index if not exists user_store_user_id_idx on user_store (user_id);\n";
/**
