import { S as lineUsdHa, f as calcularMargen, k as normalizeLine } from "./estudio-Cu-Uiuh8.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/campaign-store-B_X5Pudx.js
var MES = [
	"ene",
	"feb",
	"mar",
...
function dropFoto(id) {
	window.localStorage.setItem(LS_FOTOS, JSON.stringify(loadFotos().filter((f) => f.id !== id)));
}
//#endregion
