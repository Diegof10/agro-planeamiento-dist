...
import { c as cedearToUsd, l as isKnownCedear, s as cedearRatio, u as ratioLabel } from "./router-CdEJY5Qd.mjs";
import { r as cn } from "./site-nav-BTEAvpny.mjs";
import { a as PageMain, i as PageHeader, n as DeskGrid, o as ScrollPane, r as Page, t as ChipRow } from "./page-C2E_KfGY.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/cartera-CIblSK3b.js
...
function saveClient(name) {
	window.localStorage.setItem(LS_CLIENT, name.trim().slice(0, 80) || "Presentación confidencial");
}
...
var SplitComponent = CarteraDesk;
//#endregion
