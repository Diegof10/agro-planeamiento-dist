...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DTciDnms.mjs");
...
var manifest = {
	"20635d31f10982ef0028445f7fcd4ddbe445a104f2c9da2da89b310f87e6e5a1": {
		functionName: "putUserStore_createServerFn_handler",
		importer: () => import("./user-store-Bz3uPpVd.mjs")
	},
	"7f50cb161ab175b9fac0f2920dc5ae01f98064f679a7bb8628dce216c51b506f": {
		functionName: "loadUserStore_createServerFn_handler",
		importer: () => import("./user-store-Bz3uPpVd.mjs")
	},
	"a489f487c4e9a3a4238e07c2866aa2674ec88be11daa4a855f91e27ef58ff3d5": {
		functionName: "putUserStoreAll_createServerFn_handler",
		importer: () => import("./user-store-Bz3uPpVd.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-doTuhIHg.mjs").then((n) => n.t),
